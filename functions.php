...
add_image_size( 'wpbs-featured-carousel', 800, 533, true);
add_image_size( 'bones-thumb-600', 600, 150, false );
add_image_size( 'bones-thumb-300', 300, 100, true );
add_image_size( 'big-thumb-300', 300, 300, true );
add_image_size( 'staff-photo', 225, 300, true );
/* 
...
function bones_register_sidebars() {
    register_sidebar(array(
    	'id' => 'sidebar1',
    	'name' => 'Sidebar Area 1',
    	'description' => 'Used on page template.',
	...
	register_sidebar(array(
    	'id' => 'sidebar-program',
    	'name' => 'Sidebar for Program pages',
    	'description' => 'Used on individual program pages.',
    	'before_widget' => '<div id="%1$s" class="widget %2$s">',
    	'after_widget' => '</div>',
    	'before_title' => '<h3 class="widgettitle">',
    	'after_title' => '</h3>',
...
{ 
	...
	wp_register_style( 'calendar', get_template_directory_uri() . '/library/css/fullcalendar.min.css', array(), '1.0', 'all' );
	...
	wp_deregister_script('jquery'); // initiate the function  
  	wp_register_script('jquery', get_template_directory_uri().'/library/js/libs/jquery-1.11.2.min.js', false, '1.11.2');
	...
	wp_enqueue_script('modernizr', array('jQuery'), '2.0.6', true);
	if (is_page_template( 'page-request.php' )){
		wp_register_script('validate', get_template_directory_uri().'/library/js/jquery.validate.min.js');
		wp_enqueue_script('validate', array('jQuery'), '1.1', true);
	}
}
...
function theme_js(){
  ...
  wp_register_script('pretty', get_template_directory_uri().'/library/js/prettify.js');
  ...
  //wp_register_script('bootstrap-inputmask', get_template_directory_uri().'/library/js/bootstrap-inputmask.js');
  //wp_register_script('bootstrap-rowlink', get_template_directory_uri().'/library/js/bootstrap-rowlink.js');
  wp_register_script('bootstrap-fileupload', get_template_directory_uri().'/library/js/bootstrap-fileupload.js');
  wp_register_script('wpbs-scripts', get_template_directory_uri().'/library/js/scripts.js');
  wp_register_script('jquery-ui', get_template_directory_uri().'/library/js/jquery-ui-1.10.2.custom.min.js');
  wp_register_script('moment', get_template_directory_uri().'/library/js/moment.min.js');
  wp_register_script('calendar', get_template_directory_uri().'/library/js/fullcalendar.min.js');
  wp_register_script('gcal', get_template_directory_uri().'/library/js/gcal.js');
  ...
  wp_enqueue_script('bootstrap', array('jQuery'), '2.2.2', true);
  //wp_enqueue_script('bootstrap-transition', array('jQuery'), '2.2.2', true);
  //wp_enqueue_script('bootstrap-alert', array('jQuery'), '2.2.2', true);
  //wp_enqueue_script('bootstrap-modal', array('jQuery'), '2.2.2', true);
  //wp_enqueue_script('bootstrap-dropdown', array('jQuery'), '2.2.2', true);
  //wp_enqueue_script('bootstrap-scrollspy', array('jQuery'), '2.2.2', true);
  //wp_enqueue_script('bootstrap-tab', array('jQuery'), '2.2.2', true);
  //wp_enqueue_script('bootstrap-tooltip', array('jQuery'), '2.2.2', true);
  //wp_enqueue_script('bootstrap-popover', array('jQuery'), '2.2.2', true);
  //wp_enqueue_script('bootstrap-button', array('jQuery'), '2.2.2', true);
  //wp_enqueue_script('bootstrap-collapse', array('jQuery'), '2.2.2', true);
  //wp_enqueue_script('bootstrap-carousel', array('jQuery'), '2.2.2', true);
  //wp_enqueue_script('bootstrap-typeahead', array('jQuery'), '2.2.2', true);
 // wp_enqueue_script('bootstrap-affix', array('jQuery'), '2.2.2', true);
 // wp_enqueue_script('bootstrap-inputmask', array('jQuery'), '2.2.2', true);
 // wp_enqueue_script('bootstrap-rowlink', array('jQuery'), '2.2.2', true);
  wp_enqueue_script('bootstrap-fileupload', array('jQuery'), '2.2.2', true);
  wp_enqueue_script('wpbs-scripts', array('jQuery'), '1.0', true);
  wp_enqueue_script('jquery-ui', array('jQuery'), '1.1', true);
  wp_enqueue_script('moment', array('jQuery'), '1.1', true);
  wp_enqueue_script('calendar', array('jQuery'), '1.1', true);
  wp_enqueue_script('gcal', array('jQuery'), '1.1', true);
